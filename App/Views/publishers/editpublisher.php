...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Uppdatera Förlag</li>
 </ol>
...
<div class="row">
	<div class="col-md-6 mx-auto">
		<div class="card card-body bg-light mt-5">
			...
			<form action="<?php echo URLROOT;?>publishers/editpublisher/<?php echo $data['ID']?>" method="post">
			<?php echo Csrf::csrfTokenTag();?>
			<input type="hidden" name="ID" value="<?php echo $data['ID']; ?>">
				<div class="form-group">
				<label for="updatepublisher">Namn: <sub>*</sub></label>
				<input type="text" name="publishername" id="updatepublisher" class="form-control form-control-lg  <?php echo (!empty($data['publishername_err'])) ? 'is-invalid' : '' ;?>" value="<?php echo $data['publishername'];?>">
